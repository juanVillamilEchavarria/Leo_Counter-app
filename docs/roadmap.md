...
- [Completado ] sumar y restar el saldo actual de una cuenta cuando se realicen movimientos
- [Completado ] verificar antes de crear un movimiento, que la cuenta tenga saldo suficiente para hacerlo
- [ ] Script para registrar movimientos automáticos diarios
- [Completado ] Validaciones de tablas con relaciones antes de eliminar, no permitir sin antes reasignar
...
- [ Completado ] Crear toda la logica del backend de reportes para la generacion de estadisticas

## 3. Frontend / UX
- [ Completado] Interfaces separadas para:
...
- [Completado ] Botón de registrar movimiento automático 
- [Completado ] Ocultar Boton de Eliminar para registros de modelos que tengan relaciones asociadas 
...
- [ ] Actualizar los componentes de reportes para que usen ya los datos del backend y no datos estaticos


## 4. Reportes
- [ Completado] Asociar movimientos con presupuestos vía JOIN y BETWEEN
...
- [Completado ] terminar de configurar las API
