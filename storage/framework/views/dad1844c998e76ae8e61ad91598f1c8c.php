...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.email-layout','data' => ['title' => 'Movimiento Creado Automáticamente','headerBackground' => 'linear-gradient(135deg, #1e5f3a 0%, #2c8a4e 100%)','headerSubtitle' => 'Gestión Financiera Inteligente']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Movimiento Creado Automáticamente','headerBackground' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('linear-gradient(135deg, #1e5f3a 0%, #2c8a4e 100%)'),'headerSubtitle' => 'Gestión Financiera Inteligente']); ?>
