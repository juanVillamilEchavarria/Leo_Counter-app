...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.email-layout','data' => ['title' => 'Movimiento Pendiente Creado','headerBackground' => 'linear-gradient(135deg, #d97706 0%, #f59e0b 100%)','headerSubtitle' => 'Gestión Financiera Inteligente']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Movimiento Pendiente Creado','headerBackground' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('linear-gradient(135deg, #d97706 0%, #f59e0b 100%)'),'headerSubtitle' => 'Gestión Financiera Inteligente']); ?>
