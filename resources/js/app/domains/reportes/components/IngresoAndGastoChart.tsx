...
const promedio ={
    promedio_ingresos: 2000,
    promedio_gastos: 1500
}
const data = [
    ...
    <Card>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-bold">Promedios:</p>
          <div className="flex gap-2">
          {(mode === "ambos" || mode === "ingresos") && (
            <p className="text-green-700">Ingresos: <span className="font-semibold">${promedio.promedio_ingresos}</span></p>
          )}
          {(mode === "ambos" || mode === "gastos") && (
            <p className="text-red-700">Gastos: <span className="font-semibold">${promedio.promedio_gastos}</span></p>
          )}
        </div>
