...
export default function Reporte() {
  return (
    <SectionTransition>
      ...
      <div className="flex w-full gap-10 mx-auto h-full mb-8">
        <IngresoCardReview />
        <GastoCardReview />
          ...
          <div className="flex flex-col mt-5 gap-2 w-full">
            <div className="flex items-center gap-1">
              <p className=" text-center font-bold">
                Volumen de movimientos <span className="text-green-600">4.4%</span> superior en este mes
              </p>
