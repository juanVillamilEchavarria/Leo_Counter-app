...
Route::middleware(RedirectIfUsersAreEmptyMiddleware::class)->group(function () {
    ...
    Route::middleware(['rate.limit:5,2,ip_email'])->group(function () {
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\AdminMiddleware::class)->group(function () {
        Route::get('/exportaciones', [\App\Http\Controllers\Exportacion\ExportacionController::class, 'index'])->name('exportaciones.index');
