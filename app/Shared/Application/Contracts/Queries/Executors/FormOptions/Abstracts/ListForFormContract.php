...
/**
 * Contrato que debe implementar cada dominio que sea una opción para los formularios, para ser listada en el formulario de creación y edicións
...
interface ListForFormContract{
     ...
     * @param QueryContract $query El query que contiene la información necesaria para obtener las opciones de formulario
