...
abstract readonly class EloquentPaginatedTableQueryExecutor
{
    ...
    /**
     * Construye el query con todos los filtros, búsqueda y ordenamiento aplicados,
     * pero SIN aplicar paginación. Útil para exportaciones.
     *
     * @return Builder<Model>
     */
    public function buildQueryForExport(TableQuery $dto): Builder
    {
        $query = $this->queryWithRelations();
