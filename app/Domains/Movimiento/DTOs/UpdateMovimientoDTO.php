...
class UpdateMovimientoDTO extends MovimientoDTO
{
  ...
  public function __construct(string $nombre, int $cuenta_id, int $categoria_id, int $tipo_movimiento_id, float $monto, ?string $descripcion = null, ?int $movimiento_pendiente_id = null, ?array $comprobantes = null, ?array $comprobantes_delete_ids = null)
  {
