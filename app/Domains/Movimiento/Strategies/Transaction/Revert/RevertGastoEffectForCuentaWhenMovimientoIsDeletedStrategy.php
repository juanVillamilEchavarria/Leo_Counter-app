...
/**
 * Implementacion de la estrategia para revertir el efecto de un gasto cuando un movimiento es eliminado
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class RevertGastoEffectForCuentaWhenMovimientoIsDeletedStrategy implements RevertTransactionEffectForCuentaStrategyContract
{
    ...
    {
        return $command instanceof DestroyMovimientoCommand && $movimiento->getTipoMovimientoId() === TipoMovimientoEnum::GASTO->value;
    }
