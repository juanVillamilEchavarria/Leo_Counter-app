...
class MovimientoCuentaQueryIdRelationStrategy extends QueryIdRelationStrategy implements QueryIdRelationStrategyContract {
    protected string $table = 'movimientos';
    protected string $relationColumn = 'movimientos.cuenta_id';
    protected string $dtoProperty = 'cuentas';
}