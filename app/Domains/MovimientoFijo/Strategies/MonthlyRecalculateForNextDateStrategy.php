...
/**
 * Estrategia para la recalculacion de la fecha proxima en un intervalo mensual.
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class MonthlyRecalculateForNextDateStrategy implements RecalculateNextDateStrategyContract
{
    ...
    {
        return $movimientoFijo->getFrecuenciaMovimientoId() === FrecuenciaMovimientoEnum::MENSUAL;
    }
