...
/**
 * Estrategia para la recalculacion de la fecha proxima en un intervalo quincenal.
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class BiWeeklyRecalculateForNextDateStrategy implements RecalculateNextDateStrategyContract
{
    ...
    {
        return $movimientoFijo->getFrecuenciaMovimientoId() === FrecuenciaMovimientoEnum::QUINCENAL;
    }
