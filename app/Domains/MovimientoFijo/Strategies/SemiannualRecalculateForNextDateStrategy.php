...
/**
 * Estrategia para la recalculacion de la fecha proxima en un intervalo semestral.
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class SemiannualRecalculateForNextDateStrategy implements RecalculateNextDateStrategyContract
{
    ...
    {
        return $movimientoFijo->getFrecuenciaMovimientoId() === FrecuenciaMovimientoEnum::SEMESTRAL;
    }
