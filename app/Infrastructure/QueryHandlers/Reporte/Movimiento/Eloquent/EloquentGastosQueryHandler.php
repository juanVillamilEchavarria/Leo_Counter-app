...
use App\Infrastructure\Persistence\Builders\Reporte\EloquentGastosBuilder;
...
final class EloquentGastosQueryHandler extends EloquentMovimientoTableQueryHandler implements ReporteQueryHandlerContract
{
    ...
    {
        return $type instanceof MovimientoReporteQueryType && $type === MovimientoReporteQueryType::GASTOS;
    }
