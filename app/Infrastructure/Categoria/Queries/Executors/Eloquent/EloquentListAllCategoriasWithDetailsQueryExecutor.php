 ...
 *
 * El método `list` recibe un query de tipo ListCategoriasQueryContract y devuelve una colección de resultados que representa las categorías obtenidas con detalles completos, incluyendo las relaciones definidas en el modelo Eloquent.
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @package App\Infrastructure\Categoria\Queries\Executors\Eloquent
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class EloquentListAllCategoriasWithDetailsQueryExecutor implements CategoriaQueryExecutorContract{
