 ...
 */
final readonly class CachedCategoryDistributionQueryExecutor extends CacheReportQueryExecutor implements ReporteQueryExecutorContract
{

    public function __construct(
         EloquentCategoryDistributionQueryExecutor $executor
    ) {
