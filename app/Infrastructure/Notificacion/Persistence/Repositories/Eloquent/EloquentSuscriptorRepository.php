...
final class EloquentSuscriptorRepository extends EloquentRepository implements SuscriptorNotificacionRepositoryContract
{
    ...
    protected function mapDatabaseRecordToAggregate(Model $model): AggregateModelContract
    {
        return SuscriptorAggregate::reconstitute(
            ...
            verified_at: new Date(new \DateTimeImmutable($model->verified_at)),
