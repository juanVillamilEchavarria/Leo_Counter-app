...
/**
 * Contrato que debe implementar la clase encargada de obtener la lista de propietarios para un formulario de cuenta
 ...
 * @version 1.0.0
 */
interface ListPropietarioForFormContract extends ListForFormContract
{
}