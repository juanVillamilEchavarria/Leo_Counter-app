 ...
 * Este handler recibe un query de tipo GetCategoriaRecordsCountQuery y utiliza un executor para ejecutar la consulta y obtener el resultado.
 * @author Juan Villamil <juanestebanvillamilechavarria@gmail.com>
 * @package App\Application\Categoria\Queries\Handlers
 * @since 1.0.0
 * @version 1.0.0
 */
final readonly class GetCategoriaRecordsCountHandler
{
     ...
     * @param GetCategoriaRecordsCountQuery $query El query que representa la intención de obtener el conteo de registros de categorías.
     * @return int El número total de categorías registradas en el sistema.
     */
    public function __invoke(GetCategoriaRecordsCountQuery $query): int
    {
