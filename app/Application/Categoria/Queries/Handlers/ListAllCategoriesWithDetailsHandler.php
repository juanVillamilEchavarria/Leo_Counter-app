 ...
 * Este handler recibe un query de tipo ListAllCategoriesWithDetailsQuery y delega la ejecución de la consulta al ejecutor correspondiente, que implementa el contrato ListCategoriesExecutorContract.
...
final readonly class ListAllCategoriesWithDetailsHandler 
{
    public function __construct(
        /**
         * @param ListCategoriesExecutorContract $listCategoriesExecutor El ejecutor encargado de manejar la consulta de listar categorías
         */
        private ListCategoriesExecutorContract $listCategoriesExecutor
    ) {
    }
