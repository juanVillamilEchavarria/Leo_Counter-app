...
// │                                                                         │
// │ Este DTO base fue reemplazado por los comandos de escritura             │
// │ (StoreMovimientoPendienteCommand, UpdateMovimientoPendienteCommand)     │
// │ y el DTO de lectura (MovimientoPendienteEditDTO).                       │
// │                                                                         │
