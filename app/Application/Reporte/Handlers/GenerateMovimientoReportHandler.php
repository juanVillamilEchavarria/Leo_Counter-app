 ...
 * @version 1.0.0
 */
final class GenerateMovimientoReportHandler implements ReportContributorContract
{
    /**
    ...
    {
        $repository = $this->repositoryResolver->resolve(DomainReportQueryType::MOVIMIENTOS);
        $result = $repository->getMultiple($types, $dto);
        $previousDto = null;
        ...
        foreach ($types as $type) {
            ...
            $previousCollection = $repository->get($type, $previousDto);
